...
/* The city with the best customers, one city that has the highest sum of invoice totals. */
...
/* The track names that have a song length longer than the average song length. */
...
/* The amount spent by each customer on artists */
